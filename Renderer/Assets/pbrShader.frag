...
void main()
{
	...
	vec3 V = normailze(cameraPos - _Position);
	vec3 Lo = vec3(0.0);
	
	//reflectance loop
	for(int i = 0; i < numLights; i++)
	{
		vec3 L = normailze(lightPositions[i] - _Position);
		...
		specular = numerator / denomenator;
